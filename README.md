...
- Remplacer des plugins par de petites fonctions simples.
- Garder le site léger et indépendant des géants du web.
...
- [Mon site](https://vincentbreton.fr)
- [Mastodon](https://piaille.fr/@VincentBreton)
- [GitHub](https://github.com/vincentbreton-auteur)
